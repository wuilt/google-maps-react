(function (global, factory) {
  ...
  var eventNames = ['ready', 'click', 'dragend', 'recenter', 'bounds_changed', 'center_changed', 'dblclick', 'dragstart', 'heading_change', 'idle', 'maptypeid_changed', 'mousemove', 'mouseout', 'mouseover', 'projection_changed', 'resize', 'rightclick', 'tilesloaded', 'tilt_changed', 'zoom_changed'];
  ...
  var Map = exports.Map = function (_React$Component) {
    ...
    _createClass(Map, [{
      ...
      value: function loadMap() {
        ...
        if (this.props && this.props.google) {
          ...
          eventNames.forEach(function (eventName) {
            _this4.listeners[eventName] = _this4.map.addListener(eventName, _this4.handleEvent(eventName));
          });
      ...
      value: function render() {
        ...
        var style = _extends({}, mapStyles.map, this.props.style, {
          display: visible ? 'inherit' : 'none'
        });
        var containerStyles = _extends({}, mapStyles.container, containerStyle);
